...
#%% Learn inv dynamics
fnet = FeatureNet(n_actions=4, n_latent_dims=2, n_hidden_layers=1, n_units_per_layer=32, lr=0.002)
# fnet.print_summary()
...
# --- Save video to file ---
# ani = matplotlib.animation.FuncAnimation(fig, lambda i: animate(i, steps_per_frame=5), frames=100, interval=1, repeat=False)
